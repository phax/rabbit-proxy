...
public class ETagUtils
{
   ...
   */
  public static boolean isWeak (final String t)
  {
   ...
   */
  public static boolean checkStrongEtag (final String et, final String im)
  {
   ...
   * @return true if the etags match or at least one of the etag headers do not
   *         exist.
   */
  public static boolean checkWeakEtag (final HttpHeader h1, final HttpHeader h2)
  {
    final String et1 = h1.getHeader ("Etag");
    final String et2 = h2.getHeader ("Etag");
