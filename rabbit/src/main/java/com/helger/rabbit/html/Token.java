...
public class Token
{
   ...
   *        unmodified.
   */
  public Token (final Tag tag, final boolean changed)
  {
    this (tag, -1);
    setChanged (changed);
  }
   ...
   */
  public Token (final String text, final TokenType type, final int startindex)
  {
    this.text = text;
    this.type = type;
   ...
   */
  public Token (final char [] page, final TokenType type, final int startindex, final int len)
  {
    this.page = page;
    this.type = type;
    this.startindex = startindex;
   ...
   *        the start index of this token.
   */
  public Token (final Tag tag, final int startindex)
  {
    this.tag = tag;
  ...
  {
    if ((type == TokenType.TEXT || type == TokenType.COMMENT) && text == null)
  ...
  /**
   * Empty this token, That is set its type to EMPTY and set the text and tag to
   * null.
   */
  public void empty ()
  {
