...
public class CacheUtils
{
   ...
   * @param real
   *        false if this is a temporary cache file, true if it is a realized
   *        entry.
   * @param extension
   *        the file extension to use
   * @return the file to use for the cached object
   */
  public static File getEntryName (final File baseDir, final long id, final boolean real, final String extension)
  {
    File f;
    if (!real)
    {
    ...
    {
      final long fdir = id / FILES_PER_DIR;
