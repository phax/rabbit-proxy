...
class NCacheElementBase
{
  ...
  public NCacheElementBase (final long id, final long cachetime, final long expires, final long size)
  {
    this.id = id;
   ...
   *        the new expiry-date.
   */
  public void setExpires (final long d)
  {
    this.expires = d;
  }
   ...
   */
  public void setValues (final long id, final long cachetime, final long expires, final long size)
  {
    this.id = id;
    this.cachetime = cachetime;
    this.expires = expires;
